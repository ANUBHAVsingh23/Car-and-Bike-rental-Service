...
<body>
    <div class="up" id="up">
        <div class="logo"><img src="images/wheelzonrent-logo.png" height="100%" width="9.7%"
                style="float:left;margin:-1.2% 0 0 6.5%;">
            <img height="25%" width="1.6%" src="images/phone.png" style="height:auto;">
            <font style="font-size:1.254vw;">&ensp;+91-7380718141&emsp;</font>
            <img height="21%" width="1.9%" src="images/message.png" style="height:auto;">
            <font style="font-size:1.254vw;">&ensp;singh.anubhav3945@gmail.com</font>
        </div>
        <div class="logo1">
    ...
    <div style="text-align:center;padding:1% 0 5% 0"><img src="images/wheelzonrent-logo.png" style="height:auto;"
    ...
    <table class="tabl2" bgcolor="#00afe5" height="100px">
        <tr>
            <td>
                <h2 style="font-size:2vw;color:white;text-align:center;float:right;margin:auto;">WHAT ABOUT PRICING?
                </h2>
            </td>
            <td>
                <h3 style="font-size:1vw;color:white;text-align:center;float:left;margin:auto;">&emsp;&emsp;Dont worry.
                    We provide very nice deals and the most competative price just for you!</h3>
            </td>
        </tr>
    </table>
    <a id="service">
        <div class="servtext">
            ...
            <h3 style="font-size:0.9vw;color:white;text-align:center;margin-top:2%;">"To travel is to take a journey
                into yourself and Be a 'Story Teller' for generations"</h3>
        </div>
        <br><br>
        <div style="margin-top:5%;">
            <table style="width:82%;margin:auto;">
                <tr>
                    <td>
                        <img src="images/carp.png" style="float:left;" style="height:auto;">
                        <h1 style="font-size:1.4vw;color:black;">CAR RENTAL SERVICE</h1>
                        <h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">wheelzonrent offers to
                            make it easy for clients to get the right car at
                            the right price at the right time. If you are looking for car rental service in Delhi/India
                            or minibusses hire
                            services, then our company is the right option for you. Get the best deal on booking of
                            luxury car and coaches in Delhi.</h3>
                    ...
                    <td>
                        ...
                        <h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Our planning,
                            communication and tracking support, make us accessible to you whenever and
                            wherever you require. Our proprietary planning methodology and our custom-designed and
                            engineered fleet management system gives
                    ...
                    <td>
                        ...
                        <h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Wheelzonrent is
                            emerging car rental company in delhi/india . We have been known in industry
                            for our 100% customer satisfaction. We think for a special occasion we need the right car at
                            right prices, wheelzonrent provides
                ...
                <tr>
                    <td>
                        ...
                        <h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">While customer is
                            traveling with us we care the all needs of our clients. We offer
                            well-maintained cars with Professionally Trained Chauffeurs to Corporate at suitable rates
                            on premium and luxury car rental
                    ...
                    <td>
                        ...
                        <h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Wheelzonrent is a very
                            customer friendly company where customer service and
                            satisfaction come first. wheelzonrent provides self-driven cars to customers at very
                            convenient prices and gives
                            absolutely new and young well-maintained fleet for hassle-free and memorable driving
                            experience.</h3>
                    ...
                    <td>
                        ...
                        <h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Wheelzonrent is
                            providing One Way Drop Services From Delhi / NCR. We offer
                            to make it easy for clients to get the right car at the right price at the right time. If
                            you are looking for
        ...
        <div class="context">
            ...
            <h3 style="color:white;font-size:1vw;text-align:left;">Quality is never an accident, it is always the result
                of high intention,
        ...
        <footer>
            <table style="height:10%;">
                ...
                <tr bgcolor="#252525">
                    ...
                    <td class="widget">
                        <p class="text1">Address: Uttar Predesh , Jaunpur, India <br>
                            <img src="images/phone.png">&emsp;+91-7380718141<br>
                            <img src="images/message.png">&emsp;singh.anubhav3945@gmail.com
                        </p>
                    </td>
                </tr>
                <tr bgcolor="black">
                    <td class="copyright" colspan="2">
                        <font>Copyright 2025- All Right Reserved</font>
                    </td>
                </tr>
            </table>
        </footer>
